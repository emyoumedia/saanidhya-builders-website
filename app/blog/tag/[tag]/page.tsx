...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  return {
    title: `Posts tagged "${params.tag}" | Saanidhya Builders Blog`,
    description: `All blog articles tagged with "${params.tag}" from Saanidhya Builders.`,
    alternates: { canonical: `https://www.saanidhyabuilders.com/blog/tag/${params.tag}` },
  }
}
    ...
    <div className="bg-cream min-h-screen">
      <section className="bg-navy pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 text-center relative">
          ...
          <h1 className="font-playfair font-bold text-white text-4xl md:text-5xl mb-3">
            #{tag}
          </h1>
