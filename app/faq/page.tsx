...
import { faqData, company } from '@/data'
    ...
    <>
      ...
      <section className="bg-navy pt-32 pb-14">
        <div className="container mx-auto px-4 md:px-6">
          <nav
            className="flex items-center gap-2 text-white/40 text-sm font-montserrat mb-6"
          ...
          <div className="space-y-10">
            {faqData.map((cat) => (
              <div key={cat.category}>
                <h2 className="font-playfair font-bold text-navy text-xl mb-4 pb-2 border-b border-navy/10">
                  {cat.category}
                </h2>
                <div className="space-y-3">
                  {cat.items.map((item) => (
                    ...
                    >
                      <summary className="flex items-center justify-between gap-4 p-5 cursor-pointer font-montserrat font-semibold text-navy text-sm list-none hover:text-orange transition-colors">
                        {item.question}
                        <span className="text-orange text-xl flex-shrink-0 group-open:rotate-45 transition-transform duration-200 leading-none">
                          +
                        </span>
                      </summary>
          ...
          <div className="mt-12 p-7 bg-navy rounded-2xl text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-green-500 text-white font-montserrat font-semibold text-sm px-5 py-2.5 rounded-xl hover:bg-green-600 transition-colors"
              >
