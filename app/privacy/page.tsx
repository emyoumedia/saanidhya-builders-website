...
export const metadata: Metadata = {
  title: 'Privacy Policy | Saanidhya Builders',
  description:
    'Privacy Policy for Saanidhya Builders. Learn how we collect, use, and protect your personal information when you use our website or construction services.',
          ...
          <article className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-navy/5">
            ...
            <p className="font-montserrat text-sm text-navy/65 leading-relaxed mb-10
              ...
              <a href={BASE} className="text-orange hover:underline">
                www.saanidhyabuilders.com
              </a>{' '}
              or use our construction services. Please read this policy carefully. If you
            ...
            <div className="mt-12 pt-8 border-t border-navy/8">
              <p className="font-montserrat text-xs text-navy/40 leading-relaxed">
                ...
                from this policy shall be subject to the exclusive jurisdiction of the courts
