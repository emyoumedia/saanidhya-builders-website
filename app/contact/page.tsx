...
// Script errors are visible in the Apps Script execution log.
  ...
  return (
    <>
      ...
      {/* ── Quick contact strip ── */}
      <section className="bg-navy border-t border-white/6 py-6">
              ...
              const inner = (
                <div className="flex items-start gap-3 bg-white/5 border border-white/8 rounded-xl p-4 h-full hover:border-white/15 transition-colors">
                  ...
                  <div className="min-w-0">
                    <p className="font-montserrat text-[10px] text-white/35 uppercase tracking-wider mb-0.5">{label}</p>
                    <p className="font-montserrat text-xs text-white/70 leading-snug truncate">{value}</p>
                  </div>
                </div>
              )
              return href ? (
          ...
          <div className="grid lg:grid-cols-5 gap-10">
              ...
              <AnimatedSection direction="right">
                ...
                <div className="bg-white rounded-2xl border border-navy/8 shadow-sm overflow-hidden">
                  ...
                  <ul className="divide-y divide-navy/5">
                    ...
                    ].map(({ icon: Icon, color, label, text, sub, href, external }) => (
                      <li key={label} className="px-5 py-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="min-w-0 flex-1">
                            <p className="font-montserrat text-[10px] text-navy/35 uppercase tracking-wider mb-0.5">{label}</p>
                            {href ? (
                              <a href={href}
                              ...
                              <p className="font-montserrat text-xs text-navy font-medium leading-snug">{text}</p>
                            )}
                            {sub && <p className="font-montserrat text-[10px] text-navy/35 mt-0.5">{sub}</p>}
                          </div>
                        </div>
                      </li>
                    ))}
                ...
                <div className="flex items-start gap-3 bg-orange/6 border border-orange/15 rounded-xl px-4 py-3">
                  <div className="w-1.5 h-1.5 rounded-full bg-orange flex-shrink-0 mt-1.5" />
            ...
            <div className="lg:col-span-3">
              <AnimatedSection direction="left">
                <div className="bg-white rounded-2xl shadow-sm border border-navy/6 p-7 sm:p-9">
                  <AnimatePresence mode="wait">
                    ...
                    {submitted ? (
                      <motion.div key="success"
                        ...
                        <h3 className="font-playfair text-xl font-bold text-navy mb-2">Message Sent!</h3>
                      ...
                      <motion.form key="form" onSubmit={handleSubmit} className="space-y-5">
                        <div className="mb-1">
                          <h2 className="font-playfair font-bold text-navy text-xl mb-1">
                            Send Us a Message
                          </h2>
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                          <div>
                            <label className="font-montserrat text-xs font-semibold text-navy/60 mb-1.5 block uppercase tracking-wide">
                              Full Name *
                            </label>
                            <input
